...
\begin{proof}
    ...
    \end{equation}
    % \begin{equation}\label{耗散性-求和}
    %     \sum_{k=0}^{n-1} \left(a_{n,k+1}-a_{n,k}\right) \frac{\|x^k\|^2+\|x^n\|^2}{2}\leqslant\max_{0\leqslant k\leqslant n} \|x^k\|^2.
    % \end{equation}
...
\begin{proof}
    ...
    \begin{align*}
        ...
        \\&\leqslant 2^{-1}\Bigl(\max_{0\leqslant k<n} \|e^k\|^2 + \|e^n\|^2\Bigr) %\left(t_n-t_{n-1}\right)^\alpha\sum_{k=0}^{n-1}\left(a_{n,k+1}-a_{n,k}\right)\frac{\|e^k\|^2+\|e^n\|^2}{2}
